...
fun runAllScenarios(warehousesGraph: List<Warehouse>, packages: List<Package>,vehicleRepo: VehicleRepository,warehouseRepo: WarehouseRepository) {
    ...
    runStandaloneUseCaseDemos(warehousesGraph, vehicleRepo, warehouseRepo)
}
